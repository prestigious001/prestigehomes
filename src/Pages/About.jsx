...
export default function About() {
  return (
    <div>
       <div className="bg-gray-100 py-10 font-mono">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          <h1 className="text-4xl font-mono font-bold text-gray-800 mb-4">ABOUT US</h1>
          <p className="text-lg text-gray-600 mb-8">
            Welcome to <span className="font-semibold font-mono text-black">Prestige Property</span>, where we help you find your dream home, land, or rental property with ease.
          </p>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="bg-white shadow-lg p-6 rounded-lg">
            <h2 className="text-2xl font-semibold text-gray-800 mb-4 font-mono">Our Mission</h2>
          ...
          <div className="bg-white shadow-lg p-6 rounded-lg">
            <h2 className="text-2xl font-semibold text-gray-800 mb-4 font-mono">Why Choose Us?</h2>
            <p className="text-gray-600 leading-relaxed">
        ...
        <div className="mt-12">
          <div className="bg-white shadow-lg p-6 rounded-lg">
            <h2 className="text-2xl font-semibold text-gray-800 mb-4 text-center font-mono">Our Core Values</h2>
            <ul className="text-gray-600 list-disc pl-5 font-mono">
        ...
        <div className="mt-12 text-center">
          <h2 className="text-2xl font-semibold text-gray-800 mb-4 font-mono">Get in Touch</h2>
