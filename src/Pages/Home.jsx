  ...
  return (
    <div>
      ...
      <div className="home-tag mt-8 md:mt-16">
        ...
        <h1 class="text-center font-mono font-semibold md:text-3xl mb-4">
          HOW IT WORKS?
        </h1>
        <div className="max-w-sm md:max-w-4xl text-center rounded overflow-hidden shadow-lg bg-white md:mx-60">
